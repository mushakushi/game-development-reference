...
| Observer Scriptable Object Pattern | Prefer [Scriptable Object Event Channels](https://youtu.be/WLDgtRNK2VE?si=OjcJ6IuyUfzevii7&t=354) over plain C# events when using the [Observer pattern](https://refactoring.guru/design-patterns/observer) (versus using a MonoBehaviour). This allows for cross-scene communication in addition to the benefits of the underlying pattern. |
...
| Use Awaitables over Coroutines | For versions of Unity after 2023 use Unity’s [Awaitables](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/Awaitable.html). UniTask predates this solution. is supported on versions of Unity before 2023, and can be found [here](https://openupm.com/packages/com.cysharp.unitask/). |
